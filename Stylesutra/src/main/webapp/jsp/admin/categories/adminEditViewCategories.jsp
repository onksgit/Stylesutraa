		...
		<div class="row justify-content-center">
			<div class="col-md-4">
				<div class="card mt-5 ">
					...
					<div class="card-body">
						<form action="adminEditSaveCategory" method="Post">
						<div class="mb-3">
							<label for="category_id" class="col-form-label">Id:</label> <input
								type="text" class="form-control" id="category_id"
								name="category_id"  value="${categories.category_id}" readonly="readonly">
						</div>
						<div class="mb-3">
							<label for="category_name" class="col-form-label">Name:</label> <input
								type="text" class="form-control" id="category_name"
								name="category_name" value="${categories.category_name}" required="required">
						</div>
<!-- 						<div class="mb-3"> -->
